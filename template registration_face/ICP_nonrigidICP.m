function [sourceV]=ICP_nonrigidICP(targetV,sourceV,targetF,sourceF,iterations,flag_prealligndata, figureOn)
...
[error1,sourceV,transform] = ICP_rigidICP(targetV,sourceV,1,Indices_edgesS,Indices_edgesT);
else
    [error1,sourceV,transform] = ICP_rigidICP(targetV,sourceV,0,Indices_edgesS,Indices_edgesT);
end
